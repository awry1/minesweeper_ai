...
def plot_feature_importances(feature_importances, feature_names):
    ...
    FILENAME = os.path.join(DIRECTORY, f'FeatureImportance_{BOARD_SIZE}_{MINES}_{ITERATIONS}.png')
...
def visualize_decision_tree(decision_tree):
    ...
    DIRECTORY = os.path.join('DECISION_TREES', f'{MODEL}')
    FILENAME = os.path.join(DIRECTORY, f'DecisionTree_{BOARD_SIZE}_{MINES}_{ITERATIONS}.png')
...
if __name__ == '__main__':
    # Load the model
    DIRECTORY = os.path.join('DECISION_TREES', f'{MODEL}')
    FILENAME = os.path.join(DIRECTORY, f'DecisionTree_{BOARD_SIZE}_{MINES}_{ITERATIONS}.pkl')
