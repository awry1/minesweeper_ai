from game import *
from _3_solve_mlp import load_model, convert_board_to_numerical
from _1_solve_analytical import update_risk_board, choose_least_risky_move, find_undiscovered_fields
...
if __name__ == '__main__':
    MODEL_FILENAME = os.path.join('MODELS', f'SMP_Model_MLP_{SIZE}.pth')
